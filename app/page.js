...
const JSONLD_FAQ = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "Is Disaster Map free to use?", acceptedAnswer: { "@type": "Answer", text: "Yes. The free tier allows 10 simulations per hour and 30 per day across all 6 scenarios. Pro (from $6.99/month or $18.99 founders lifetime) unlocks higher limits, globe view, and full map interaction." } },
...
const FAQS = [
  ...
  { q: "Is Disaster Map free to use?", a: "Yes. The free tier provides access to all 6 scenarios with 10 simulations per hour and 30 per day. The map locks after triggering a catastrophe — unlock Pro (from $6.99/month) for full pan, zoom, and higher limits." },
          ...
          <section id="pricing" style={{ maxWidth: 940, margin: "0 auto", padding: "80px 40px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(255px,1fr))", gap: 24 }}>
              {[
                ...
                { tier: "Pro Lifetime", price: "$18.99", period: "one-time · founders price", color: "#f97316", badge: "FOUNDERS", features: ["All 7 disaster scenarios","50 simulations / hour","200 simulations / day","Globe + Satellite view","Full pan, zoom & explore","Locked in forever — price rises"], cta: "https://buy.stripe.com/8x23cv7eE9w62qa6vra3u09", ctaLabel: "Lock in Founders Price" },
                { tier: "Pro Monthly", price: "$6.99", period: "/ month", color: "#60a5fa", badge: null, features: ["All 7 disaster scenarios","50 simulations / hour","200 simulations / day","Globe + Satellite view","Full pan, zoom & explore","Cancel anytime"], cta: "https://buy.stripe.com/6oU5kDcyYbEe4yi6vra3u0a", ctaLabel: "Subscribe Monthly" },
                ...
                <div key={p.tier} style={{ border: `1px solid ${p.tier === "Pro Lifetime" ? p.color : p.color + "33"}`, borderRadius: 14, padding: "30px 26px", background: p.tier === "Pro Lifetime" ? "rgba(249,115,22,0.06)" : "rgba(255,255,255,0.018)", display: "flex", flexDirection: "column", position: "relative" }}>
