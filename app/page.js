...
export default function HomePage() {
  ...
  const [inputLevel, setInputLevel] = useState(10);
  ...
  const executeFlood = () => {
    ...
    setSeaLevel(level);
    setStatus(`Loading flood tiles for ${level > 0 ? "+" : ""}${level}m...`);
  ...
  const switchToGlobeLocked = () => {
    setStatus("Globe is disabled until 2D flood tiles are working");
  };
    ...
    <div style={{ width: "100%", height: "100vh", position: "relative", overflow: "hidden" }}>
      ...
      >
        ...
        <div style={{ fontSize: 13, color: "#666", marginBottom: 20 }}>
          Scalable flood-tile architecture
        </div>
        ...
        <div style={{ marginBottom: 24 }}>
          ...
          <div style={{ display: "grid", gap: 8 }}>
            ...
            >
              Standard Map
              <div style={{ fontSize: 12, opacity: 0.8, marginTop: 3 }}>Flood tiles run here</div>
            </button>
            ...
            >
              Satellite View 🔒
              <div style={{ fontSize: 12, opacity: 0.8, marginTop: 3 }}>Pro later</div>
            </button>
            ...
            >
              Globe View 🔒
              <div style={{ fontSize: 12, opacity: 0.8, marginTop: 3 }}>Later</div>
            </button>
          </div>
        </div>
        ...
        >
          ...
          <div style={{ fontSize: 13, color: "#374151", lineHeight: 1.5 }}>
            Get stable 2D flood tiles working first. Then upgrade the tile server from fake tiles to real coastline flooding.
          </div>
        </div>
      </div>
