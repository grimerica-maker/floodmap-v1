...
const JSONLD_FAQ = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "Is Disaster Map free to use?", acceptedAnswer: { "@type": "Answer", text: "Yes. The free tier allows 10 simulations per hour and 30 per day across all 6 scenarios. Pro ($18.99 founders lifetime (going up to $24.99 soon)) unlocks higher limits, globe view, and full map interaction." } },
