...
export default function HomePage() {
  ...
  const triggerCataclysm = () => {
    ...
    const info = model === "davidson"
      ...
      : { name: "The Ethical Skeptic ECDO", flipBearing: 80, newPoleLat: -13.5, newPoleLng: 31, newPoleLabel: "New N. Pole (S. Africa 31°E)", finalBearing: 80, startBearing: 0, snapLat: 20, snapLng: -20 };
